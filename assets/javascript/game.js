...
// console log the entire array of characters
	...
	for (var i = 0; gamePlayObj.characterArrayList.length > i; i++) {
...
// Function displays all of the characters on the screen
	...
	loopThroughChar: function(object){
		var parent = document.getElementById(object.yourCharacterId);
			console.log(parent);

		object.array.forEach(function(character, index, arr){
			console.log("This is the arr parameter of for each loop: " + arr);
			var div  = document.createElement('div');
			div.setAttribute('class', 'characterContainer characterClick ' + object.background);

			// sets the index of each div
			...
			var characterName = document.createTextNode(object.array[index].name);
			...
			img.setAttribute('src', object.array[index].visual);  
			...
			var characterHealthPoints = document.createTextNode(object.array[index].healthPoints);
